...
public class ComputerTest {
    ...
    public void testEquals() {
        Computer computer1 = new Computer("Коса", 2, 2, "Домашний компьютер");
        Computer computer2 = new Computer("Коса", 2, 2, "Домашний компьютер");
    ...
    public void testNotEquals() {
        Computer computer1 = new Computer("Коса", 2, 2, "Домашний компьютер");
        Computer computer2 = new Computer("Коса", 2, 4, "Домашний компьютер");
